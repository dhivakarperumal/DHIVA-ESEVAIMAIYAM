...
const mockCharges = [
  { id: 1, name: 'Standard Certificate Fee', amount: 120, type: 'Fixed', description: 'Base fee for most certificates (Income, Community, Nativity)', status: 'Active' },
  { id: 2, name: 'Premium Service Fee', amount: 250, type: 'Fixed', description: 'Expedited processing fee', status: 'Active' },
  { id: 3, name: 'Aadhaar Demographic Update', amount: 50, type: 'Fixed', description: 'UIDAI mandated fee for demographic updates', status: 'Active' },
  { id: 4, name: 'Aadhaar Biometric Update', amount: 100, type: 'Fixed', description: 'UIDAI mandated fee for biometric updates', status: 'Active' },
  { id: 5, name: 'Convenience Fee', amount: 2, type: 'Percentage', description: 'Gateway convenience fee applied on total', status: 'Inactive' },
];
  ...
  return (
    <div className="flex flex-col gap-6 text-white p-2 sm:p-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-semibold mb-1">Service Charges</h1>
          <div className="text-sm text-gray-400 flex items-center gap-2">
            <span>Dashboard</span>
            <span className="text-gray-600">&gt;</span>
            <span>Service Management</span>
            <span className="text-gray-600">&gt;</span>
            <span className="text-gray-200">Service Charges</span>
          </div>
        </div>
      ...
      <div className="bg-[#1a1c23] border border-gray-800 rounded-xl p-4 flex flex-wrap gap-4 items-center">
        <div className="relative flex-1 min-w-[250px]">
          ...
          <input 
            type="text" 
            placeholder="Search charge configurations..." 
      ...
      <div className="bg-[#1a1c23] border border-gray-800 rounded-xl overflow-hidden">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-800 text-gray-400 text-sm">
                <th className="py-4 px-4 pl-6 font-medium">Charge Name</th>
            ...
            <tbody>
              {mockCharges.map((charge) => (
                <tr key={charge.id} className="border-b border-gray-800/50 hover:bg-gray-800/20 transition-colors">
                  <td className="py-3 px-4 pl-6">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-green-500/20 text-green-400">
                        <IndianRupee size={20} />
                      </div>
                  ...
                  <td className="py-3 px-4 text-sm text-gray-300">
                    <span className="bg-gray-800 px-2.5 py-1 rounded-md">{charge.type}</span>
                  </td>
        ...
        <div className="p-4 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-sm text-gray-400">
            Showing 1 to 5 of 5 charge configurations
          </div>
        ...
        <>
          ...
          <div className={`fixed inset-y-0 right-0 w-[400px] bg-[#1a1c23] border-l border-gray-800 shadow-2xl z-[70] transform transition-transform duration-300 flex flex-col ${isAddOpen ? 'translate-x-0' : 'translate-x-full'}`}>
            <div className="flex items-center justify-between p-6 border-b border-gray-800">
              <div>
                <h2 className="text-xl font-semibold text-white">Add Charge Config</h2>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-5 custom-scrollbar">
              <div className="space-y-1.5">
                <label className="text-sm text-gray-300 font-medium">Charge Name <span className="text-red-500">*</span></label>
                <input type="text" placeholder="Enter charge config name" className="w-full bg-[#0f1115] border border-gray-800 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-gray-600" />
              </div>

              <div className="flex gap-4">
                <div className="flex-[2] space-y-1.5">
                  <label className="text-sm text-gray-300 font-medium">Type <span className="text-red-500">*</span></label>
                  <div className="relative">
                    <select defaultValue="Fixed" className="w-full bg-[#0f1115] border border-gray-800 rounded-lg px-3 py-2 text-sm text-gray-400 appearance-none focus:outline-none focus:border-gray-600 cursor-pointer">
                ...
                <div className="flex-[3] space-y-1.5">
                  <label className="text-sm text-gray-300 font-medium">Value <span className="text-red-500">*</span></label>
                  <input type="number" placeholder="Enter value" className="w-full bg-[#0f1115] border border-gray-800 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-gray-600" />
                </div>
              </div>

              <div className="space-y-1.5">
                <label className="text-sm text-gray-300 font-medium">Description <span className="text-red-500">*</span></label>
                <textarea rows="4" placeholder="Enter description" className="w-full bg-[#0f1115] border border-gray-800 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-gray-600 resize-none"></textarea>
